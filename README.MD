...
Выполнение задач из раздела настроек  "Do:" в программе прописано в жестком порядке. Для задач, которые требуют остановки сервиса 1с, сервис на время выполнения задач будет остановлен, после запущен. Задачи будут выполняться все, если это возможно.
